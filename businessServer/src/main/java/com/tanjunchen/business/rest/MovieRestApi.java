package com.tanjunchen.business.rest;

import com.tanjunchen.business.model.domain.Tag;
import com.tanjunchen.business.model.domain.User;
import com.tanjunchen.business.model.recom.Recommendation;
import com.tanjunchen.business.model.request.*;
import com.tanjunchen.business.service.*;
import com.tanjunchen.business.utils.Constant;
...
public class MovieRestApi {
    ...
    /**
     * 获取推荐的电影【实时推荐 6 + 内容推荐 4】
     * @param username
     * @param model
     * @return
     */
    // TODO:混合推荐结果中，基于内容的推荐，基于 MID，而非 UID
